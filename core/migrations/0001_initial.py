# Generated by Django 3.2 on 2022-01-22 07:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roll_no', models.CharField(max_length=50, verbose_name='ক্রমিক নং')),
                ...
                ('marital_status', models.CharField(choices=[('Single', 'Single'), ('Married', 'Married')], max_length=50, verbose_name='বৈবাহিক অবস্থা')),
                ...
                ('education', models.CharField(choices=[('H.S.C', 'H.S.C'), ('S.S.C', 'S.S.C'), ('J.S.C', 'J.S.C'), ('P.S.C', 'p.S.C')], max_length=50, verbose_name='শিক্ষাগত যোগ্যতা')),
                ('phone', models.CharField(max_length=11, verbose_name='মোবাইল')),
                ('status', models.CharField(choices=[('Accepted', 'Accepted'), ('Rejected', 'Rejected')], max_length=50, verbose_name='Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('session_year', models.CharField(max_length=50, verbose_name='Title')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='session', to='core.course')),
            ],
        ),
        migrations.CreateModel(
            name='Financial_aid',
            fields=[
                ...
                ('Detail', models.TextField(max_length=400, verbose_name='Detail')),
        ...
        migrations.AddField(
            model_name='applicant',
            name='session',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='applicants', to='core.session'),
        ),
        migrations.AddField(
            model_name='applicant',
            name='sub_district',
